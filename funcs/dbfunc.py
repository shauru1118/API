...
""")
    add_homework('30.09.2025', 'Физика / Информатика', '5.25, 5.28, 5.32 | Нужны иформаторы для инфмат группы')
    add_homework('30.09.2025', 'Домой / Физика', 'Домой | Нужны иформаторы для инфмат группы')
